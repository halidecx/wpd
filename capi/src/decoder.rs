...
pub use crate::status::{
    WPD_ERR_BITSTREAM, WPD_ERR_BUFFER_TOO_SMALL, WPD_ERR_INTERNAL, WPD_ERR_INVALID_ARG,
    WPD_ERR_NOT_WEBP, WPD_ERR_NO_MEMORY, WPD_ERR_TOO_LARGE, WPD_ERR_TRUNCATED,
    WPD_ERR_UNSUPPORTED, WPD_OK,
};
