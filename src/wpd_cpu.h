...
static wpd_always_inline int wpd_have_armv6(int flags) { return !!(flags & WPD_CPU_ARMV6); }
static wpd_always_inline int wpd_have_neon(int flags) { return !!(flags & WPD_CPU_NEON); }
#endif
